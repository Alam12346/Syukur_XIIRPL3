 ...
 * Class clas untuk melakukan login dan registrasi user baru 
...

{
    ...
    ## Contructor untuk class , membutuhkan satu parameter yaitu koneksi ke database ## 
...

    {
        ...
        try {
            ...
            $stmt = $this->db->prepare("INSERT INTO userr(nama, email, password) VALUES(:nama, :email, :pass)");
...

    {
        ...
        try {
            ...
            $stmt = $this->db->prepare("SELECT * FROM userr WHERE email = :email");
    ...
    public function getUser()
    {
        ...
        try {
            ...
            $stmt = $this->db->prepare("SELECT * FROM userr WHERE id = :id");
